...
- [ ] **Релиз v0.9.0** — frontend P4, CHANGELOG, bump версии. **M**
...
1. **Frontend P4** — CSV import → guest `/share/:token` → PERT рядом с Gantt/CPM.
2. **Мультивалюта** — API курсов + конвертация в Finance/Portfolio (если нужна до v0.9.0).
