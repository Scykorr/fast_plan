...
4. **P6 Project CRM** — P6a–P6e ✓; следующий: **P6f** (AI CRM).
...
### P6f — критерии готовности (следующий спринт)

- [ ] AI insights: stale clients / at-risk deals  
- [ ] Draft email / КП  
- [ ] Activity summary + auto-tasks
...
1. **P6f** — AI CRM поверх лидов/сделок.  
