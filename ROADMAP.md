...
4. **P6 Project CRM** — P6a–P6d ✓; следующий: **P6e** (автоматизация).
...
### P6e — критерии готовности (следующий спринт)

- [ ] Trigger → conditions → actions конструктор  
- [ ] Actions: create lead/deal/task, assign, webhook, delay  
- [ ] Шаблоны follow-up / form lead
...
1. **P6e + P6f** — дифференциация (автоматизация и AI).  
2. Омниканал и 1С/Stripe — по запросу клиентов, не блокеры MVP.
