...
4. **P6 Project CRM** — P6a ✓; P6b ✓; P6c ✓ (сделки); следующий: **P6d** (лиды).
...
### P6d — критерии готовности (следующий спринт)

- [ ] Lead entity + CSV/API import  
...
1. **P6d** — лиды и inbound.  
2. **P6e + P6f** — дифференциация (автоматизация и AI).  
3. Омниканал и 1С/Stripe — по запросу клиентов, не блокеры MVP.
