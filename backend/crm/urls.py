...
urlpatterns = [
    ...
    path(
        "crm/documents/<int:document_id>/share-links/",
        commerce_share.CrmDocumentShareLinkListCreateView.as_view(),
        name="crm-document-share-links",
    ),
    path(
        "crm/documents/<int:document_id>/share-links/<int:link_id>/",
        commerce_share.CrmDocumentShareLinkDetailView.as_view(),
        name="crm-document-share-link-detail",
    ),
    path(
        "crm/share/<str:token>/",
        commerce_share.PublicCrmDocumentShareView.as_view(),
        name="crm-public-document-share",
    ),
    path(
        "crm/share/<str:token>/approve/",
        commerce_share.PublicCrmDocumentApproveView.as_view(),
        name="crm-public-document-approve",
    ),
    path(
        "crm/share/<str:token>/pdf/",
        commerce_share.PublicCrmDocumentPdfView.as_view(),
